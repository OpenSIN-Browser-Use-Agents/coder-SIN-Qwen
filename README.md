...
The sidecar now launches the Chrome binary directly, disables crash-restore prompts, and opens the Qwen chat URL instead of leaving a visible `about:blank` tab behind.
