...
- sidecar startup now launches Chrome directly, seeds cloned startup URLs, suppresses crash-restore behavior, and opens the configured Qwen URL instead of a placeholder `about:blank` tab
